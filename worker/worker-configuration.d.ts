/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6d6ba0b5d7caa2f2edcbd0e57bef0988)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	SYNC_TOKEN: string;
	KANZEN_WORKSPACE: DurableObjectNamespace<import("./src/index").KanZenWorkspace>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "KanZenWorkspace";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SYNC_TOKEN">> {}
}
